% adapted version by Till Habersetzer 22.10.2021
...
mkdir final_stimuli
audiowrite(['final_stimuli',filesep,'up.wav'],c_up/max(abs(c_up)),fsamp);
audiowrite(['final_stimuli',filesep,'down.wav'],c_dn/max(abs(c_up)),fsamp);
