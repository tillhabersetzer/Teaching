function experiment_up(f,Settings,name)
%--------------------------------------------------------------------------
% parameters: 
%
% f:        figure handle
...
[stim,SampFreq] = audioread(fullfile(p,'..','Stimuli','rms_equalized','up_rmseq.wav'));
...
disp('Wiedergabe von experiment_up.m erfolgreich beendet.')
