...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% !!!!SCRIPT IS DESIGNED FOR Windows!!!!
...
% load headmodel
headmodel = importdata([pathi,subjectdata.subjectname,'_headmodel_meg.mat']); % mm
% load sourcemodel
sourcemodel = importdata([pathi,subjectdata.subjectname,'_sourcemodel.mat']); % mm
